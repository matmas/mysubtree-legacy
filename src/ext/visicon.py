...
class Visicon(object):
    ...
    def __init__(self, hash, size=24, background=0xffffff):
        ...
        possibly be interpreted from the supplied ``hash``.
    ...
    def draw_centre(self):
        ...
        """
        self.draw_glyph(self.block_centre, 0, {'x': self.size, 'y': self.size}, self.fg_colour, False)
